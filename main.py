...
books_data = [
    ("Evangelho segundo Mateus", 28, "mt"), ("Evangelho segundo Marcos", 16, "mc"),
    ("Evangelho segundo Lucas", 24, "lc"), ("Evangelho segundo João", 21, "jo"), ("Atos dos Apóstolos", 28, "atos"), ("Carta aos Romanos", 16, "rm"),
    ("I Coríntios", 16, "1co"), ("II Coríntios", 13, "2co"), ("Gálatas", 6, "gl"),
    ("Carta aos Efésios", 6, "ef"), ("Carta aos Filipenses", 4, "fp"), ("Carta aos Colossenses", 4, "cl"),
    ("I Tessalonicenses", 5, "1ts"), ("II Tessalonicenses", 3, "2ts"), ("I Timóteo", 6, "1tm"),
    ("II Timóteo", 4, "2tm"), ("Carta a Tito", 3, "tt"), ("Carta a Filemom", 1, "fm"), ("Hebreus", 13, "hb"),
    ("Carta de Tiago", 5, "tg"), ("I Pedro", 5, "1pe"), ("II Pedro", 3, "2pe"), ("I João", 5, "1jo"),
    ("II João", 1, "2jo"), ("III João", 1, "3jo"), ("Carta de Judas", 1, "jd"), ("Apocalipse", 22, "ap")
]
...
def main():    
    ...
    for book in books:
        ...
        for chapter in range(1, book.chapters + 1):
            ...
            page_path = f"/ava/{book.code}/{chapter}"
